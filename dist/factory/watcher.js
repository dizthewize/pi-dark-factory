...
export function getQueuePath(factoryDir) {
 ...
 */
export function pollManualQueue(factoryDir) {
 ...
 */
export function startFileWatcher(factoryDir, onTasks, intervalMs = 5000) {
    let timer = null;
    let lastMtime = 0;
    const filePath = getQueuePath(factoryDir);
    const check = () => {
